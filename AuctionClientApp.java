...
/**
* This class represents the client GUI that is used by the client who participates the auction.
* Making the class implement the DialogClientInterface allows it to be informed whenever there has been an event generated by the dialog
*
* @author Guannan Zhao
* @version %I%, %G%
* @since 1.0
...
public class AuctionClientApp extends JFrame implements DialogClientInterface{
   ...
   // This interface connects to an AuctionClient that handles all the work 
   ...
   private void addListeners(){
      ...
      // Add a listener for key presses in the bidAmount textfield
